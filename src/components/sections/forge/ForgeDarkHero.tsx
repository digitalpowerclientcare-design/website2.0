    ...
    <section className="relative flex min-h-[100svh] items-center overflow-hidden text-white">
      ...
      <div className="content-container relative z-10 py-24 md:py-32">
        ...
        >
          ...
          <h1 className="text-[44px] leading-[1.05] font-light tracking-[-0.04em] text-white md:text-[68px] lg:text-[80px]">
            Your team is using AI to write code.
          </h1>
          <h1
            className="mt-2 text-[44px] leading-[1.05] font-light tracking-[-0.04em] md:text-[68px] lg:text-[80px]"
            style={{
              backgroundImage:
